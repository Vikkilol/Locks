...
function positionLocks() {
   ...
   /*     { id: 1, xPercent: 17.5, yPercent: 82, message: "Send messages to your favorite people ❤️", img: "lock2r.png", size: 45 },
        ...
        { id: 7, xPercent: 50, yPercent: 89, message: "❤️ selfmate + centen ❤️", img: "lock4r.png", size: 100 },
        { id: 8, xPercent: 50, yPercent: 107, message: "❤️ pirioca + centen ❤️", img: "lock1r.png", size: 65 },
        { id: 9, xPercent: 27.5, yPercent: 103, message: "❤️ kahei + Muse ❤️", img: "lock4r.png", size: 100}
/*        { id: 7, xPercent: 33.75, yPercent: 95, message: "Use a template, or use your own lock image!", img: "lock1r.png", size: 65 },
        ...
        { id: 15, xPercent: 78.75, yPercent: 82.75, message: "Fill out the form when you're ready!", img: "lock5r.png", size: 100 }
        */
    ];
