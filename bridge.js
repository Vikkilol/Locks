...
function positionLocks() {
   ...
   /*     { id: 1, xPercent: 17.5, yPercent: 82, message: "Send messages to your favorite people ❤️", img: "lock2r.png", size: 45 },
        ...
        { id: 20, xPercent: 65.5, yPercent: 102, message: "❤️To: Skyles_Daughter-----------From: Anonymous❤️", img: "lock1r.png", size: 65},
        { id: 21, xPercent: 88, yPercent: 104, message: "❤️Boyo + badcrookshanks❤️", img: "shanksboy.png", size: 47}
