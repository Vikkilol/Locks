...
function positionLocks() {
   ...
   /*     { id: 1, xPercent: 17.5, yPercent: 82, message: "Send messages to your favorite people ❤️", img: "lock2r.png", size: 45 },
        ...
        { id: 13, xPercent: 32, yPercent: 91, message: "❤️ centen + pinkmelodies ❤️", img: "lock5r.png", size: 100},
        { id: 14, xPercent: 30, yPercent: 91, message: "❤️ shadow + MK3AMisSleepy ❤️", img: "mk3.png", size: 60}  
