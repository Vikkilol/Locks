...
function positionLocks() {
    ...
    const locks = [
        { id: 1, xPercent: 17, yPercent: 82, message: "Send messages to your favorite people ❤️", img: "lock1.png", size: 50 },
        { id: 2, xPercent: 33, yPercent: 95, message: "Use a template, or use your own lock image!", img: "lock2.png", size: 65 },
