...
function positionLocks() {
    ...
    const locks = [
        { id: 1, xPercent: 17.5, yPercent: 82, message: "Send messages to your favorite people ❤️", img: "lock2r.png", size: 65 },
        { id: 2, xPercent: 33.5, yPercent: 95, message: "Use a template, or use your own lock image!", img: "lock1r.png", size: 50 },
