...
function positionLocks() {
   ...
   /*     { id: 1, xPercent: 17.5, yPercent: 82, message: "Send messages to your favorite people ❤️", img: "lock2r.png", size: 45 },
        ...
        { id: 7, xPercent: 45, yPercent: 89, message: "❤️ selfmate + centen ❤️", img: "lock4r.png", size: 100 },
        { id: 8, xPercent: 50, yPercent: 109, message: "❤️ pirioca + centen ❤️", img: "lock1r.png", size: 65 },
        { id: 9, xPercent: 25, yPercent: 103, message: "❤️ kahei + Muse ❤️", img: "lock4r.png", size: 100}
