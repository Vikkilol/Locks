document.addEventListener("DOMContentLoaded", () => {
    ...
    function positionLocks() {
        ...
        const locks = [
            ...
            { id: 11, column: 19.58, yAlign: 0.6, message: "❤️To: respectable082---------------From:Anonymous❤️", img: "lock1r.png", size: 85 },
            { id: 12, column: 13.86, yAlign: 0.85, message: "❤️ Harmony_Starz + Espoir ❤️", img: "lock5r.png", size: 130 },
            { id: 13, column: 7.3, yAlign: 0.09, message: "❤️ centen + pinkmelodies ❤️", img: "lock5r.png", size: 130 },
            ...
            { id: 16, column: 7.48, yAlign: 0.28, message: "❤️ badcrookshanks + Boyo ❤️", img: "lock1r.png", size: 85 },
            { id: 17, column: 10.34, yAlign: 0.65, message: "❤️ Harmony_Starz + crimson ❤️", img: "lock5r.png", size: 130 },
