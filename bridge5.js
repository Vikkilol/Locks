document.addEventListener("DOMContentLoaded", () => {
    ...
    function positionLocks() {
        ...
        const locks = [
            ...
            { id: 11, column: 23, yAlign: 0.08, message: "❤️To: respectable082---------------From:Anonymous❤️", img: "lock1r.png", size: 85 },
            ...
            { id: 22, column: 21, yAlign: 0.08, message: "❤️zena + Ahsoka❤️", img: "vik.png", size: 95 }
        ];
