document.addEventListener("DOMContentLoaded", () => {
    ...
    function positionLocks() {
        ...
        const locks = [
            { id: 6, column: 15.07, yAlign: 0.035, message: "❤️ pinkmelodies + ChiaraNextDoor17 ❤️", img: "lock4r.png", size: 100 },
            ...
            { id: 14, column: 14.2, yAlign: 0.065, message: "❤️To: shadow---------------From:Anonymous❤️", img: "love.png", size: 75 },
            { id: 15, column: 11.25, yAlign: 0.34, message: "❤️To: velvet---------------From:Anonymous❤️", img: "love.png", size: 75 },
            { id: 16, column: 7.5, yAlign: 0.35, message: "❤️ badcrookshanks + Boyo ❤️", img: "lock1r.png", size: 85 },
            { id: 17, column: 10.25, yAlign: 0.081, message: "❤️ Harmony_Starz + crimson ❤️", img: "lock5r.png", size: 130 },
            ...
            { id: 21, column: 18.75, yAlign: 0.33, message: "❤️Boyo + badcrookshanks❤️", img: "shanksboy.png", size: 60 },
